...
音声関連サービス「キコエル」の開発・運用

| 項目     | 詳細                |
|--------|-------------------|
| 担当役割   | バックエンドエンジニア・テックリード |
| チーム規模  | 約 5名              |
| 技術スタック | Go、Cloud Native技術（Google Cloud）、Terraform、gRPC/Connect-go、GraphQL、マイクロサービスアーキテクチャ など |
...
エンタープライズ向けシステム開発・運用保守

| 項目     | 詳細                |
|--------|-------------------|
| 担当役割   | バックエンドエンジニア |
| チーム規模  | 約 8名              |
| 技術スタック | Go、AWS、Terraform、CI/CD、マイクロサービスアーキテクチャ など |
