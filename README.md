...
バックエンドエンジニア~SREをメインにしていますが、フロントエンドやデータ分析周りに関する動きもします。

チーム全体の生産性向上や持続的な開発のなかでプロダクトの価値を継続的に高めていくことを重視して活動しています。
...
### 2023.06 - 現在 / 株式会社S(業務委託)

#### 概要

セキュリティリスク診断プラットフォームの開発・保守運用
...
- SaaSのセキュリティリスク診断実施のための機能開発の設計・実装・QA
  - Design DocやADRを作成、チームでの合意形成を行う
- 他サービスとのID統合などFE・BEの広範囲にわたる機能開発
- コードレビュー
...
- Next.js13(App Router)を用いた管理画面開発
  - 技術選定
  - 開発基盤用意
  - タスクアサイン
  - デザイン・実装
